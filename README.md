...
学校・企業・医療・行政など、あらゆる組織で使える **セルフホスト型の生成AIアプリポータル** です。  
...
| | |
|---|---|
| **対象** | Dify / Langflow をすでに運用している組織 |
| **目的** | 複数のAIアプリを1つのポータルに集約し、権限管理・チャット履歴保存をひとまとめに行う |
...
```bash
git clone https://github.com/YOUR_USERNAME/agent-ai-portal.git
cd agent-ai-portal
```
